...
\paragraph{Soluzione} Per risolvere il problema è stato utilizzato il \textit{pattern Template Method}. È stata introdotta una classe astratta AbstractEnemyImpl 
...
la duplicazione di codice e un aumento delle dipendenze tra classi, rendendo difficile la manutenzione e l’estensione del sistema.
...
Mi sono occupato principalmente della progettazione dei nemici, della loro creazione e del loro correto movimento allinterno del livello.
Ho inoltre lavorato alla totale struttora del livello 2 con i propri oggeti e alla correta visione del player allinterno dei livello 1 e 2 con l'implementazione di camera
\end{document}
